...
public class PaginationViewModel extends ExtendedDataModel{
    ...
    public int callAPItoGetData(){
    	...
    	System.out.println("Table Name at client side = " + table_name);
		...
		System.out.println("Total Rows DynamicPagination = " + totalRows);
