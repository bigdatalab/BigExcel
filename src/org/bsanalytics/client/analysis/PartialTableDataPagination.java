...
//import org.bsanalytics.client.viewdata.ViewTableBackingBean;
import org.bsanalytics.dashboard.ServerAccessPath;
import org.bsanalytics.general.client.ClientSideGsonConversion;

public class PartialTableDataPagination extends ExtendedDataModel {
    ...
    CustomTableViewBean take_rows_range;
    ...
    public PartialTableDataPagination(){
    	//table_name_obj = new ViewTableBackingBean();
    	System.out.println("==========in constructor=====");
    	take_rows_range = new CustomTableViewBean();
  ...
  /*  public void connectToDBandInitiateCursor(){
    ...
    public int callAPItoGetData(){
    	String table_name = take_rows_range.getView_table_name();
    ...
    public String callAPItoGetPartialData(){
    	...
    	Resource resource = client_wink.resource(
	 			"http://localhost:8080/bsanalytics/jaxrs_query/query_data/"+table_name+"/"+"3:10"+"/pl/analytics");
